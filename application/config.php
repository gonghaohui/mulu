...
return [
    ...
    'view_replace_str'       => [
        ...
        '__TIYU_CSS__' => '/static/tiyu/css',
        '__TIYU_JS__'  => '/static/tiyu/js',
        '__TIYU_IMG__' => '/static/tiyu/images',
...
//     异常处理handle类 留空使用 \think\exception\Handle
    ...
    'http_exception_template'    =>  [
        // 定义404错误的重定向页面地址
        404 =>  APP_PATH.'404.php',
//        404 =>  APP_PATH.'/controller/',
        //定义500错误的重定向页面地址
        500 =>  APP_PATH.'404.html'
//    500 => 'http://127.0.0.76/admin/login/index.html'
    ],
