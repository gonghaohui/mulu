<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"D:\gary\mulu\public/../application/admin\view\menu\add_rule.html";i:1626349985;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-card-body layui-form">
            <div class="layui-row layui-col-space10 layui-form-item ">
                    ...
                    <div class="layui-input-block">
                        <select name="pid" xm-select="select1" lay-verify="required" xm-select-search="" xm-select-search-type="dl">
                            ...
                            <?php if(is_array($admin_rule) || $admin_rule instanceof \think\Collection || $admin_rule instanceof \think\Paginator): if( count($admin_rule)==0 ) : echo "" ;else: foreach($admin_rule as $key=>$v): ?>
                                <option value="<?php echo $v['id']; ?>" <?php if($id == $v['id']): ?>selected="selected"<?php endif; ?> ><?php echo $v['placeholder']; ?><?php echo $v['title']; ?></option>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="title" id="menu" lay-verify="required" placeholder="菜单名称（多个名称英文逗号连接）" class="layui-input ">
                    </div>
                </div>
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
