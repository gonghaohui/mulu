<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\gary\mulu\public/../application/admin\view\news\news_list.html";i:1670998463;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="opeBar">
                ...
                <a class="layui-btn layui-btn-info layui-btn-xs" title="编辑标签" onclick="wk.href('<?php echo url('edit_new_tags'); ?>?id={{d.article_id}}')"><i class="fa fa-tag"></i></a>
...
<script>
    layui.use(['index', 'table'], function () {
        ...
        table.render({
            ...
            , url: '<?php echo url("news/news_list"); ?>'
            ,response: {
        ...
        form.on('switch(OnOff)', function (obj) {
            ...
            //菜单状态
            // alert(this.value);
            wk.status(this.value,num, '<?php echo url("news_state"); ?>',obj);
        });
