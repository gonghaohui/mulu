<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\gary\mulu\public/../application/admin\view\log\operate_log.html";i:1626349985;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="opeBar">
                <a class="layui-btn layui-btn-danger layui-btn-xs" title="删除" onclick="wk.confirm('{{d.log_id}}','<?php echo url('del_log'); ?>')"><i class="fa fa-trash-o"></i></a>
            </script>
            <!--状态模板-->
...
<script>
    layui.use(['index', 'table'], function () {
        ...
        table.render({
            ...
            , url: '<?php echo url("Log/operate_log"); ?>'
            ,response: {
        ...
        var active = {
            getCheckData: function(){
                //批量删除
                wk.batchDel(getIds(),"<?php echo url('batchDelLog'); ?>");
            }
        };
