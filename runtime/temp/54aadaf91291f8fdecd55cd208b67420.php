<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\gary\mulu\public/../application/admin\view\articles\edit_article.html";i:1634916395;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-row layui-col-space10 layui-form-item ">
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input " value="<?php echo $data['title']; ?>" name="title" lay-verify="required" placeholder="标题">
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <select name="category" id="category" lay-verify="required">
                            ...
                            <option value="<?php echo $vo['category_id']; ?>" <?php if($data['category'] == $vo['category_id']): ?>selected="selected"<?php endif; ?>><?php echo $vo['placeholder']; ?><?php echo $vo['category_name_cn']; ?></option>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input" value="<?php echo $data['author']; ?>" name="author"  placeholder="作者">
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md10">
                    ...
                    <div class="layui-input-block" >
                        <textarea name="content" id="LAY_editor2" placeholder="内容(日文)"><?php echo htmlspecialchars($data['content'],ENT_QUOTES); ?></textarea>
                    </div>
                </div>

                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label"><em>*</em>关键词(标签)</label>
                    <div class="layui-input-block">
                        <input type="text" class="layui-input" disabled="disabled" value="<?php echo $data['keywords']; ?>" name="keywords" lay-verify="required" placeholder="关键词">
                    </div>
                </div>
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label"><em>*</em>描述(导语)</label>
                    <div class="layui-input-block">
                        <textarea name="description" class="layui-textarea" lay-verify="required" style="min-height:200px;"><?php echo $data['description']; ?></textarea>
                    </div>
                </div>
...
<script>
    ...
    layui.use(['form','upload','layedit','element'], function() {
        ...
        form.on('submit(component-form-element)', function (data) {
            ...
            $.ajax({
                url:"<?php echo url('edit_article'); ?>?article_id=<?php echo $data['article_id']; ?>",
                type:'post',
                dataType:'json',
                data:data.field,
                success:function(res){
                    if (res.code == 200) {
                        layer.msg(res.msg,{icon:1,time:1500,shade:0.1},function(index){
                            // wk.layer_close();
                            window.location.href="<?php echo url('data_list'); ?>";
                        })
                    } else {
