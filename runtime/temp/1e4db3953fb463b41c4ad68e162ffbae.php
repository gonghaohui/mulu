<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"D:\gary\mulu\public/../application/tiyu\view\second\zhibo.html";i:1672821383;s:53:"D:\gary\mulu\application\tiyu\view\public\header.html";i:1671309968;s:53:"D:\gary\mulu\application\tiyu\view\public\footer.html";i:1670883333;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
    ...
    <title><?php echo $type_name; ?>直播</title>
    <meta content="<?php echo $type_name; ?>直播" name="description" />
    <meta content="<?php echo $type_name; ?>直播" name="keywords" />
...
<div class="content_box1">
    <div class="local"><a href="/index.html">首页</a> > <span><?php echo $type_name; ?>直播</span></div>
</div>
                ...
                <div class="content_match_text" id="contentZ">
                    ...
                    <li id="<?php echo $data['id']; ?>" data-id="<?php echo $data['id']; ?>" data-type="lanqiu" data-name="<?php echo $data['category_name']; ?>" class="matchItem">
                        ...
                        <div class="scoreRight">
                            <a id="contentAnalyse" class="scoreRight_active" href="/<?php echo $top_category[$second['top_id']]; ?>/<?php echo $data['id']; ?>.html" target="_blank">直播信号</a>
                        </div>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
