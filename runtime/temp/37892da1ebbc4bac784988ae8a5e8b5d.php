<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"D:\gary\mulu\public/../application/admin\view\config\group.html";i:1626349985;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-card">
        <div class="layui-tab layui-tab-card">
            <ul class="layui-tab-title">
                ...
                <a href="<?php echo url('?id='.$key); ?>"><li <?php if($id == $key): ?>class="layui-this"<?php endif; ?>><?php echo $group; ?>配置</li></a>
                                ...
                                <div class="layui-form-item layui-col-xs-offset1 layui-col-xs8">
                                    ...
                                    <div class="layui-input-block">
                                        <?php switch($config['type']): case "0": ?>
                                            <input type="text"name="config[<?php echo $config['name']; ?>]" value="<?php echo $config['value']; ?>" lay-verify="required|number" placeholder="<?php echo $config['remark']; ?>" class="layui-input ">
                                        <?php break; case "1": ?>
                                            <input type="text" name="config[<?php echo $config['name']; ?>]" value="<?php echo $config['value']; ?>" lay-verify="required" placeholder="<?php echo $config['remark']; ?>" class="layui-input ">
                                        <?php break; case "2": ?>
                                            <textarea name="config[<?php echo $config['name']; ?>]" placeholder="<?php echo $config['remark']; ?>" lay-verify="required" class="layui-textarea"><?php echo $config['value']; ?></textarea>
                                        <?php break; case "3": ?>
                                            <textarea name="config[<?php echo $config['name']; ?>]" placeholder="<?php echo $config['remark']; ?>" lay-verify="required" class="layui-textarea"><?php echo $config['value']; ?></textarea>
                                        <?php break; case "4": ?>
                                            <select name="config[<?php echo $config['name']; ?>]" lay-verify="required" lay-search="">
