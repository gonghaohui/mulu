<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\gary\mulu\public/../application/admin\view\video\video_list.html";i:1671001239;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="opeBar">
                <a class="layui-btn layui-btn-xs" title="编辑" onclick="wk.href('<?php echo url('edit_video'); ?>?id={{d.id}}')"><i class="fa fa-pencil"></i></a>
                <a class="layui-btn layui-btn-info layui-btn-xs" title="编辑标签" onclick="wk.href('<?php echo url('edit_video_tags'); ?>?id={{d.id}}')"><i class="fa fa-tag"></i></a>
...
<script>
    layui.use(['index', 'table'], function () {
        ...
        table.render({
            ...
            , url: '<?php echo url("video/video_list"); ?>'
            ,response: {
        ...
        form.on('switch(OnOff)', function (obj) {
            ...
            //菜单状态
            // alert(this.value);
            wk.status(this.value,num, '<?php echo url("videos_state"); ?>',obj);
        });
        ...
        var active = {
            getCheckData: function(){
                //批量删除
                wk.batchDel(getIds(),"<?php echo url('batchDelVideos'); ?>");
            }
        };
    ...
    function del_video(obj,id){
        layer.confirm('确认删除吗?', {icon: 7, title:'警告'}, function(index){
            //do something
            $.getJSON('<?php echo url("del_video_data"); ?>', {'id' : id}, function(res){
                if(res.code == 200){
