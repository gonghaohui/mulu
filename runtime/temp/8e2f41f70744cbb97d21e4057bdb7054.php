<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\gary\mulu\public/../application/admin\view\news\news_edit.html";i:1670330509;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body layui-form">
            <div class="layui-row layui-col-space10 layui-form-item ">
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label"><em>*</em>新闻分类</label>
                    <div class="layui-input-block">
                        <select name="c_id" id="c_id" lay-verify="required">
                            ...
                            <option value="<?php echo $vo['category_id']; ?>" <?php if($data['c_id'] == $vo['category_id']): ?>selected="selected"<?php endif; ?>><?php echo $vo['placeholder']; ?><?php echo $vo['category_name']; ?></option>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input" value="<?php echo $data['keywords']; ?>" name="keywords" placeholder="关键词">
                    </div>
                </div>
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label">描述</label>
                    <div class="layui-input-block">
                        <textarea name="description" class="layui-textarea" style="min-height:200px;"><?php echo $data['description']; ?></textarea>
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="number" class="layui-input" value="<?php echo $data['views']; ?>" name="views" placeholder="浏览量">
                    </div>
                </div>
                ...
                success:function(res){
                    if (res.code == 200) {
                        layer.msg(res.msg,{icon:1,time:1500,shade:0.1},function(index){
                            // wk.layer_close();
                            window.location.href="<?php echo url('news_list'); ?>";
                        })
                    } else {
