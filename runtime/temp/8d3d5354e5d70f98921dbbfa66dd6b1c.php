<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\gary\mulu\public/../application/admin\view\video\edit_video_tags.html";i:1671001601;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-fluid layui-col-md12">
    <div class="layui-card">
        ...
        <div class="layui-card-header">修改录像标签</div>
...
<script>
    ...
    function del_tag(r_id,tag_id){
        ...
        $.ajax({
            url:"<?php echo url('del_video_tag'); ?>?id=<?php echo $data['id']; ?>",
            type:'post',
            dataType:'json',
            data:{r_id:r_id,tag_id:tag_id},
            success:function(res){
                if (res.code == 200) {
                    window.location.href="<?php echo url('edit_video_tags'); ?>?id=<?php echo $data['id']; ?>";
                } else {
                    wk.error(res.msg);
                    return false;
                }
    ...
    $('#add_tags').click(function (){
        ...
        $.ajax({
            url:"<?php echo url('edit_video_tags'); ?>?id=<?php echo $data['id']; ?>",
            type:'post',
            dataType:'json',
            data: {tags:tags},
            success:function(res){
