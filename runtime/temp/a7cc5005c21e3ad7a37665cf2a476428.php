<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\gary\mulu\public/../application/admin\view\news\edit_category.html";i:1673435596;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-row layui-col-space10 layui-form-item ">
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <select id="t" name="pid" lay-verify="required">
                            <option value="1" <?php if($category['t']== 1): ?>selected="selected"<?php else: ?>disabled="disabled"<?php endif; ?>>足球</option>
                            <option value="2" <?php if($category['t']== 2): ?>selected="selected"<?php else: ?>disabled="disabled"<?php endif; ?>>篮球</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <select id="type" name="type" lay-verify="required">
                            <?php if(!empty($typeArray)): if(is_array($typeArray) || $typeArray instanceof \think\Collection || $typeArray instanceof \think\Paginator): if( count($typeArray)==0 ) : echo "" ;else: foreach($typeArray as $key=>$ta): ?>
                            <option value="<?php echo $ta['index']; ?>" <?php if($category['type']== $ta['index']): ?>selected="selected"<?php else: ?>disabled="disabled"<?php endif; ?>><?php echo $ta['key']; ?></option>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <select id="pid" name="pid" lay-verify="required">
                            ...
                            <option value="0" <?php if($category['pid'] == 0): ?>selected="selected"<?php endif; ?>>顶级分类</option>
                            <?php if(!empty($AllCategories)): if(is_array($AllCategories) || $AllCategories instanceof \think\Collection || $AllCategories instanceof \think\Paginator): if( count($AllCategories)==0 ) : echo "" ;else: foreach($AllCategories as $key=>$vo): ?>
                            <option value="<?php echo $vo['category_id']; ?>" <?php if($category['pid']== $vo['category_id']): ?>selected="selected"<?php endif; ?>><?php echo $vo['placeholder']; ?><?php echo $vo['category_name']; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; endif; ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="category_name" class="layui-input " value="<?php echo $category['category_name']; ?>" name="category_name" lay-verify="required" placeholder="分类名称">
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input disabled id="pinyin_other" type="text" style="width: 200px;float: left;" class="layui-input " value="<?php echo $category['pinyin_other']; ?>" name="pinyin_other" placeholder="url">
                        <input id="pinyin" type="text" style="width: 200px;float: left;" class="layui-input " value="<?php echo $category['pinyin']; ?>" name="pinyin" lay-verify="required" placeholder="拼音">
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="status" value="1" title="是" <?php if($category['status'] == 1): ?>checked<?php endif; ?>>
                        <input type="radio" name="status" value="0" title="否" <?php if($category['status'] == 0): ?>checked<?php endif; ?>>
                    </div>
                </div>
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label">导航栏显示</label>
                    <div class="layui-input-block">
                        <input type="radio" name="show_navigation" value="1" title="是" <?php if($category['show_navigation'] == 1): ?>checked<?php endif; ?>>
                        <input type="radio" name="show_navigation" value="0" title="否" <?php if($category['show_navigation'] == 0): ?>checked<?php endif; ?>>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="support" value="1" title="是" <?php if($category['support'] == 1): ?>checked<?php endif; ?>>
                        <input type="radio" name="support" value="0" title="否" <?php if($category['support'] == 0): ?>checked<?php endif; ?>>
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input " id="tag_name" name="tag_name" value="<?php echo $tag_name; ?>" placeholder="标签名">
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="number" class="layui-input" value="<?php echo $category['sort']; ?>" onkeyup="value=value.replace(/[^\d]/g,'')" autocomplete="off" name="sort" placeholder="排序(数字越小排越前面)">
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <textarea name="keywords" class="layui-textarea" placeholder="文章描述"><?php echo $category['keywords']; ?></textarea>
                    </div>
                </div>
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label">描述</label>
                    <div class="layui-input-block">
                        <textarea name="description" class="layui-textarea" placeholder="文章描述"><?php echo $category['description']; ?></textarea>
                    </div>
                </div>
...
<script>
    ...
    // wk.uploadImg({size:5,num:1,type:'jpg,png',url:"<?php echo url('Upload/uploadLocality'); ?>"});
    //
    // //百度富文本编辑器
    ...
    layui.use(['form','upload','layedit','element'], function() {
        ...
        form.on('submit(component-form-element)', function (data) {
            ...
            $.ajax({
                url:"<?php echo url('edit_category'); ?>?category_id=<?php echo $category['category_id']; ?>",
                type:'post',
                dataType:'json',
                data:data.field,
                success:function(res){
