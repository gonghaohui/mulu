<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"D:\gary\mulu\public/../application/admin\view\data\import.html";i:1626349985;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="opeBar">
                <a class="layui-btn layui-btn-xs"   onclick="restore('<?php echo url('revert'); ?>','{{d.time}}')" title="还原" ><i class="fa fa-magic"></i></a>
...
<script>
    ...
    function dataDel(obj,id){
        layer.confirm('确认删除此备份?', {icon: 3, title:'提示'}, function(index){
            $.getJSON("<?php echo url('delData'); ?>", {'id' : id}, function(res){
                if(res.code == 200){
