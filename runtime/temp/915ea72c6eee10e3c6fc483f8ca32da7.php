<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\gary\mulu\public/../application/admin\view\video\video_edit.html";i:1671000626;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-fluid layui-col-md12">
    <div class="layui-card">
        ...
        <div class="layui-card-header">修改录像</div>
        <div class="layui-card-body layui-form">
            <div class="layui-row layui-col-space10 layui-form-item ">
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label"><em>*</em>录像分类</label>
                    <div class="layui-input-block">
...
<script>
    ...
    layui.use(['form','upload','layedit','element'], function() {
        ...
        form.on('submit(component-form-element)', function (data) {
            ...
            $.ajax({
                url:"<?php echo url('edit_video'); ?>?id=<?php echo $data['id']; ?>",
                type:'post',
                dataType:'json',
                data:data.field,
                success:function(res){
                    if (res.code == 200) {
                        layer.msg(res.msg,{icon:1,time:1500,shade:0.1},function(index){
                            // wk.layer_close();
                            window.location.href="<?php echo url('video_list'); ?>";
                        })
                    } else {
