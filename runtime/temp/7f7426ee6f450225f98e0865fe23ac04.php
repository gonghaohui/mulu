<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"D:\gary\mulu\public/../application/admin\view\menu\index.html";i:1626349985;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-form layui-card-header layuiadmin-card-header-auto">
            ...
            <div>
                <button class="layui-btn" data-type="add" onclick="wk.layer_show('添加菜单','<?php echo url('add_rule'); ?>')">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="opeBar">
                <a class="layui-btn layui-btn-info layui-btn-xs" title="添加子菜单" onclick="wk.layer_show('添加菜单','<?php echo url('add_rule'); ?>?id={{d.id}}')"><i class="fa fa-sitemap"></i></a>
                <a class="layui-btn layui-btn-xs" title="编辑" onclick="wk.layer_show('编辑菜单','<?php echo url('edit_rule'); ?>?id={{d.id}}')"><i class="fa fa-pencil"></i></a>
    ...
    layui.use(['index', 'table','util'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'title', width: '' ,title: '权限名称', align: 'left',edit: 'text',templet:'<div>{{d.placeholder}}{{d.title}}</div>'}
                , {field: 'css', width: 80, title: '图标', align: 'center',templet:'<div><i class="{{d.css}}"></i></div>'}
        ...
        table.on('edit(LAY-table-manage)', function(obj){
            ...
            wk.change(data.id,"<?php echo url('editField'); ?>",field,value,'auth_rule');
        });
