<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\gary\mulu\public/../application/admin\view\highlight\highlight_edit.html";i:1671005303;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body layui-form">
            <div class="layui-row layui-col-space10 layui-form-item ">
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label"><em>*</em>图片地址</label>
                    <div class="layui-input-block">
                        <input type="text" class="layui-input " value="<?php echo $data['img']; ?>" name="img" lay-verify="required" placeholder="图片地址">
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <select name="hot" lay-verify="required">
                            <option value="0" <?php if($data['hot'] == 0): ?>selected<?php endif; ?>>不推荐</option>
                            <option value="1" <?php if($data['hot'] == 1): ?>selected<?php endif; ?>>推荐</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md10">
                    ...
                    <div class="layui-input-block" >
                        <textarea name="content" id="LAY_editor2" placeholder="内容"><?php echo htmlspecialchars($data['content'],ENT_QUOTES); ?></textarea>
                    </div>
                </div>
...
<script>
    ...
    layui.use(['form','upload','layedit','element'], function() {
        ...
        form.on('submit(component-form-element)', function (data) {
            ...
            $.ajax({
                url:"<?php echo url('edit_highlight'); ?>?id=<?php echo $data['id']; ?>",
                type:'post',
                dataType:'json',
                data:data.field,
                success:function(res){
                    if (res.code == 200) {
                        layer.msg(res.msg,{icon:1,time:1500,shade:0.1},function(index){
                            // wk.layer_close();
                            window.location.href="<?php echo url('highlight_list'); ?>";
                        })
                    } else {
