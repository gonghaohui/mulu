<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\gary\mulu\public/../application/admin\view\collection\setting.html";i:1670511696;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-card">
        <div class="layui-tab layui-tab-card">
            <ul class="layui-tab-title">
                <a href="<?php echo url('?id=1'); ?>"><li <?php if($id == 1): ?>class="layui-this"<?php endif; ?>>新闻采集配置</li></a>
                <a href="<?php echo url('?id=2'); ?>"><li <?php if($id == 2): ?>class="layui-this"<?php endif; ?>>直播采集配置</li></a>
                <a href="<?php echo url('?id=3'); ?>"><li <?php if($id == 3): ?>class="layui-this"<?php endif; ?>>录像采集配置</li></a>
                <a href="<?php echo url('?id=4'); ?>"><li <?php if($id == 4): ?>class="layui-this"<?php endif; ?>>集锦采集配置</li></a>
            </ul>
                    ...
                    <div class="layui-form">
                        ...
                        <div class="layui-form-item layui-col-xs-offset1 layui-col-xs8">
                            ...
                            <div class="layui-input-block">
                                <select name="caiji_status" lay-verify="required">
                                    <option value="0" <?php if($allow['value'] == 0): ?>selected<?php endif; ?>>关闭</option>
                                    <option value="1" <?php if($allow['value'] == 1): ?>selected<?php endif; ?>>开启</option>
                                </select>
                            </div>
                        </div>
                        <div class="layui-row layui-col-space10 layui-form-item ">
                            <div class="layui-form-item layui-col-xs-offset1 layui-col-xs8">
                                ...
                                <div class="layui-input-block">
                                    <input type="text"name="dbhost" value="<?php echo $setting['dbhost']; ?>" lay-verify="required" placeholder="" class="layui-input ">
                                </div>
                            </div>
                            <div class="layui-form-item layui-col-xs-offset1 layui-col-xs8">
                                <label class="layui-form-label">数据库帐号</label>
                                <div class="layui-input-block">
                                    <input type="text"name="dbuser" value="<?php echo $setting['dbuser']; ?>" lay-verify="required" placeholder="" class="layui-input ">
                                </div>
                            </div>
                            <div class="layui-form-item layui-col-xs-offset1 layui-col-xs8">
                                <label class="layui-form-label">数据库密码</label>
                                <div class="layui-input-block">
                                    <input type="text"name="dbpwd" value="<?php echo $setting['dbpwd']; ?>" lay-verify="required" placeholder="" class="layui-input ">
                                </div>
                            </div>
                            <div class="layui-form-item layui-col-xs-offset1 layui-col-xs8">
                                <label class="layui-form-label">数据库名</label>
                                <div class="layui-input-block">
                                    <input type="text"name="dbname" value="<?php echo $setting['dbname']; ?>" lay-verify="required" placeholder="" class="layui-input ">
                                </div>
                            </div>
