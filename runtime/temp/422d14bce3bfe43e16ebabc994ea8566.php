<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\gary\mulu\public/../application/tiyu\view\fourth\new_list.html";i:1672912198;s:53:"D:\gary\mulu\application\tiyu\view\public\header.html";i:1671309968;s:53:"D:\gary\mulu\application\tiyu\view\public\footer.html";i:1670883333;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
    ...
    <title><?php echo $fourth['category_name']; ?>新闻</title>
...
<div class="topic_subnav_box">
    <div class="topic_subnav">
        <ul>
            ...
            <ul>
                <li> <a href="" class="hover"><?php echo $fourth['category_name']; ?>新闻首页</a> </li>
                ...
                <li> <a href="/<?php echo $video_category['pinyin']; ?>/index.html" class=""><?php echo $fourth['category_name']; ?>录像</a> </li>
...
<div class="content_box">
    ...
    <div class="content_block_left">
        ...
        <div class="news_list">
            ...
            <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): if( count($lists)==0 ) : echo "" ;else: foreach($lists as $key=>$new): ?>
            <div class="block_img">
                <a href="/<?php echo $f_url; ?>/<?php echo $new['article_id']; ?>.html" class="tag_posituon">
                    <img src="<?php echo $new['thumbnail']; ?>" alt="<?php echo $new['title']; ?>" />
                </a>
                <div class="infro">
                    <h1><a href="/<?php echo $f_url; ?>/<?php echo $new['article_id']; ?>.html"><?php echo $new['title']; ?></a></h1>
                    <p><a href="/<?php echo $f_url; ?>/<?php echo $new['article_id']; ?>.html"></a></p>
