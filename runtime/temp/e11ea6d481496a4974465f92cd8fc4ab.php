<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\gary\mulu\public/../application/admin\view\zhibo\edit_zhibo_tags.html";i:1671029683;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-fluid layui-col-md12">
    <div class="layui-card">
        ...
        <div class="layui-card-header">修改直播标签</div>
            ...
            <div class="layui-row layui-col-space10 layui-form-item ">
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input" disabled="disabled" value="<?php echo $data['id']; ?>" id="id" name="id" placeholder="ID">
                    </div>
                </div>
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label"><em>*</em>主队</label>
                    <div class="layui-input-block">
                        <input type="text" class="layui-input" disabled="disabled" value="<?php echo $data['zhudui']; ?>" name="zhudui" placeholder="主队">
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input" disabled="disabled" value="<?php echo $data['kedui']; ?>" name="kedui" placeholder="客队">
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        ...
                        <div class="t-select-box">
                            ...
                            <span class="t-select"><?php echo $tag['tag_name']; ?><i class="layui-icon layui-icon-close lay-table-select-close" onclick="del_tag(<?php echo $tag['r_id']; ?>,<?php echo $tag['new_tag_id']; ?>);"></i></span>
...
<script>
    ...
    function del_tag(r_id,tag_id){
        ...
        $.ajax({
            url:"<?php echo url('del_zhibo_tag'); ?>?id=<?php echo $data['id']; ?>",
            type:'post',
            dataType:'json',
            data:{r_id:r_id,tag_id:tag_id},
            success:function(res){
                if (res.code == 200) {
                    window.location.href="<?php echo url('edit_zhibo_tags'); ?>?id=<?php echo $data['id']; ?>";
                } else {
                    wk.error(res.msg);
                    return false;
                }
    ...
    $('#add_tags').click(function (){
        ...
        $.ajax({
            url:"<?php echo url('edit_zhibo_tags'); ?>?id=<?php echo $data['id']; ?>",
            type:'post',
            dataType:'json',
            data: {tags:tags},
            success:function(res){
