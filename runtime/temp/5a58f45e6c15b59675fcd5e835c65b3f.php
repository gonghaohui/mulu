<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\gary\mulu\public/../application/admin\view\link\data_list.html";i:1630121082;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-form layui-card-header layuiadmin-card-header-auto">
            ...
            <div>
                <button class="layui-btn" data-type="add" onclick="wk.href('<?php echo url('add_link'); ?>')">
...
<script>
    layui.use(['index', 'table'], function () {
        ...
        table.render({
            ...
            , url: '<?php echo url("link/data_list"); ?>'
            ,response: {
        ...
        table.on('edit(LAY-table-manage)', function(obj){
            ...
            wk.change(data.link_id,"<?php echo url('editField'); ?>",field,value,'friend_link');
        });
    ...
    function del_link(obj,id){
        layer.confirm('确认删除吗?', {icon: 7, title:'警告'}, function(index){
            //do something
            $.getJSON('<?php echo url("del_link"); ?>', {'id' : id}, function(res){
                if(res.code == 200){
