<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\gary\mulu\public/../application/tiyu\view\second\highlight.html";i:1672469339;s:53:"D:\gary\mulu\application\tiyu\view\public\header.html";i:1671309968;s:53:"D:\gary\mulu\application\tiyu\view\public\footer.html";i:1670883333;}*/ ?>
    ...
    <div class="content_box2">
        <div class="row_one">
            <div class="col-sm-6">
                <div class="panel">
                    <div class="panel-heading">
                        <div class="panel-title">推荐<?php echo $type_name; ?>集锦</div>
                    </div>
                    <ul class="list-group">
                        <?php if(is_array($hot_highlights) || $hot_highlights instanceof \think\Collection || $hot_highlights instanceof \think\Paginator): $i = 0; $__LIST__ = $hot_highlights;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$highlight): $mod = ($i % 2 );++$i;?>
                        <li>
            ...
            <div class="col-sm-6">
                <div class="panel">
                    <div class="panel-heading">
                        <div class="panel-title">最新<?php echo $type_name; ?>集锦</div>
                    </div>
                    <ul class="panel-body list-group">
                        <?php if(is_array($latest_highlights) || $latest_highlights instanceof \think\Collection || $latest_highlights instanceof \think\Paginator): $i = 0; $__LIST__ = $latest_highlights;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$highlight): $mod = ($i % 2 );++$i;?>
                        <li>
                            <a href="/<?php echo $top_category[$highlight['top_id']]; ?>/<?php echo $highlight['id']; ?>.html" title="<?php echo $highlight['title']; ?>">
                                <b><?php echo $highlight['title']; ?></b>
                            </a>
            ...
            <div class="col-sm-6">
                <div class="panel">
                    ...
                    <ul class="panel-body list-group">
                        ...
                        <li><a href="/<?php echo $top_category[$video['top_id']]; ?>/<?php echo $video['id']; ?>.html" title="<?php echo $video['title']; ?>"><?php echo $video['title']; ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
            </div>
