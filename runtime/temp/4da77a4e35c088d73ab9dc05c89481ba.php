<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\gary\mulu\public/../application/admin\view\zhibo\zhibo_list.html";i:1671029128;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-card">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    <div class="layui-input-inline" style="width: 100px;">
                        <input type="text" id="id" class="layui-input" name="id" placeholder="直播ID"/>
                    </div>
                </div>
                <!--<div class="layui-inline">-->
                ...
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <select name="category" id="category" class="layui-input">
                            ...
                            <option value="<?php echo $vo['category_id']; ?>"><?php echo $vo['placeholder']; ?><?php echo $vo['category_name']; ?></option>
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="opeBar">
                <a class="layui-btn layui-btn-xs" title="编辑" onclick="wk.href('<?php echo url('edit_zhibo'); ?>?id={{d.id}}')"><i class="fa fa-pencil"></i></a>
                <a class="layui-btn layui-btn-info layui-btn-xs" title="编辑标签" onclick="wk.href('<?php echo url('edit_zhibo_tags'); ?>?id={{d.id}}')"><i class="fa fa-tag"></i></a>
                <a class="layui-btn layui-btn-danger layui-btn-xs" title="删除" onclick="del_zhibo(this,{{d.id}})"><i class="fa fa-trash-o"></i></a>
...
<script>
    layui.use(['index', 'table'], function () {
        ...
        table.render({
            ...
            , url: '<?php echo url("zhibo/zhibo_list"); ?>'
            ,response: {
            ...
            , cols: [[
                ...
                {field: 'zhudui', width: '' ,title: '主队', align: 'center'},
                {field: 'kedui', width: '' ,title: '客队', align: 'center'},
                {field: 'bifen', width: 100 ,title: '比分', align: 'center'},
                {field: 'lunci', width: 100 ,title: '轮次', align: 'center'},

                {field: 'create_time', width: 180, title: '开始时间', align: 'center',templet:"<div>{{layui.util.toDateString(d.create_time,'yyyy-MM-dd HH:mm:ss')}}</div>"},
        ...
        form.on('switch(OnOff)', function (obj) {
            ...
            //菜单状态
            // alert(this.value);
            wk.status(this.value,num, '<?php echo url("zhibos_state"); ?>',obj);
        });
        ...
        var active = {
            getCheckData: function(){
                //批量删除
                wk.batchDel(getIds(),"<?php echo url('batchDelZhibos'); ?>");
            }
        };
     ...
     * [del_category 删除菜单]
     */
    function del_zhibo(obj,id){
        layer.confirm('确认删除吗?', {icon: 7, title:'警告'}, function(index){
            //do something
            $.getJSON('<?php echo url("del_zhibo_data"); ?>', {'id' : id}, function(res){
                if(res.code == 200){
