<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\gary\mulu\public/../application/admin\view\articles\create_sitemap.html";i:1634367667;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-form layui-card-header layuiadmin-card-header-auto">
            ...
            <div>
                <button class="layui-btn" data-type="add" onclick="create_sitemap()">
                    <i class="fa fa-plus"></i> 生成最新的网站地址sitemap.xml
                </button>
...
<script>
    function create_sitemap(){
        $.ajax({
            type: 'post',
            url: '<?php echo url("create_sitemap"); ?>',
            data: {},
            dataType: 'json',
