<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"D:\gary\mulu\public/../application/tiyu\view\third\video.html";i:1672841020;s:53:"D:\gary\mulu\application\tiyu\view\public\header.html";i:1671309968;s:53:"D:\gary\mulu\application\tiyu\view\public\footer.html";i:1670883333;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
...
<div class="topic_subnav_box">
    <div class="topic_subnav">
        <ul>
            <li> <a href="" class="hover"><?php echo $third['video_name']; ?>录像首页</a> </li>

            <?php if($zhibo_category['pinyin'] != null): ?>
            <li> <a href="/<?php echo $zhibo_category['pinyin']; ?>/index.html" class=""><?php echo $third['video_name']; ?>直播</a> </li>
            <?php endif; if($highlight_category['pinyin'] != null): ?>
            <li> <a href="/<?php echo $highlight_category['pinyin']; ?>/index.html" class=""><?php echo $third['video_name']; ?>集锦</a> </li>
            <?php endif; if($new_category['pinyin'] != null): ?>
            <li> <a href="/<?php echo $new_category['pinyin']; ?>/index.html" class=""><?php echo $third['video_name']; ?>新闻</a> </li>
            <?php endif; ?>
        ...
        <div class="toc_right_w340">
            <div class="panel">
                <div class="panel-heading">
                    <div class="panel-title">推荐<?php echo $third['video_name']; ?>录像视频</div>
                </div>
                <ul class="list-group">
                    <?php if(is_array($hot_video) || $hot_video instanceof \think\Collection || $hot_video instanceof \think\Paginator): $i = 0; $__LIST__ = $hot_video;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$video): $mod = ($i % 2 );++$i;?>
                    <li>
            ...
            <div class="panel">
                <div class="panel-heading">
                    <div class="panel-title">最新<?php echo $third['video_name']; ?>录像视频</div>
                </div>
                <ul class="list-group">
                    <?php if(is_array($latest_video) || $latest_video instanceof \think\Collection || $latest_video instanceof \think\Paginator): $i = 0; $__LIST__ = $latest_video;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$video): $mod = ($i % 2 );++$i;?>
                    <li>
                        <a href="/<?php echo $top_category[$video['top_id']]; ?>/<?php echo $video['id']; ?>.html" title="<?php echo $video['title']; ?>">
                            <b><?php echo $video['title']; ?></b>
                        </a>
