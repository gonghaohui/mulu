<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"D:\gary\mulu\public/../application/tiyu\view\content\video.html";i:1672996257;s:53:"D:\gary\mulu\application\tiyu\view\public\header.html";i:1671309968;s:53:"D:\gary\mulu\application\tiyu\view\public\footer.html";i:1670883333;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
    ...
    <meta content="<?php echo $video['title']; ?>" name="description">
    <meta content="<?php echo $video['title']; ?>" name="keywords">
...
<div class="topic_subnav_box">
    <div class="topic_subnav">
        <ul>
            ...
            <li> <a href="/<?php echo $new_category['pinyin']; ?>/index.html" class=""><?php echo $video['name']; ?>新闻</a> </li>
            <?php endif; if($zhibo_category['pinyin'] != null): ?>
            <li> <a href="/<?php echo $zhibo_category['pinyin']; ?>/index.html" class=""><?php echo $video['name']; ?>直播</a> </li>
            <?php endif; if($video['pinyin'] != null): ?>
            <li> <a href="/<?php echo $video['pinyin']; ?>/index.html" class="hover"><?php echo $video['name']; ?>录像</a> </li>
            <?php endif; if($highlight_category['pinyin'] != null): ?>
            <li> <a href="/<?php echo $highlight_category['pinyin']; ?>/index.html" class=""><?php echo $video['name']; ?>集锦</a> </li>
            <?php endif; ?>
        </ul>
    </div>
</div>
...
<div class="content_box">
    <div class="local"><span class="one">当前位置：</span>
        ...
        <a href="/<?php echo $video['pinyin']; ?>/index.html"><span><?php echo $video['category_name']; ?></span></a>
    </div>
        ...
        <div class="articles_text_box">
            ...
            <div class="articles_text">
                <div class="title">
                    ...
                    <time><?php echo date("Y-m-d H:i:s",$video['create_time']); ?></time>
                </div>
                <p>
    ...
    <div class="content_right">
        <?php if(is_array($tag_list) || $tag_list instanceof \think\Collection || $tag_list instanceof \think\Paginator): $i = 0; $__LIST__ = $tag_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tag_video): $mod = ($i % 2 );++$i;?>
        <div class="block">
            <div class="block_title">
                <h1>相关<?php echo $tag_video['tag_name']; ?>录像</h1>
            </div>
            <div class="hot_video_con">
                <ul>
                    <?php if(is_array($tag_video['videos']) || $tag_video['videos'] instanceof \think\Collection || $tag_video['videos'] instanceof \think\Paginator): $i = 0; $__LIST__ = $tag_video['videos'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$video): $mod = ($i % 2 );++$i;?>
                    <li> <img style="width: 12px" src="/static/tiyu/images/919901b301f64ce5b2622ae2fe536d3e.gif">
                        <a href="/<?php echo $top_category[$video['top_id']]; ?>/<?php echo $video['id']; ?>.html" title="<?php echo $video['title']; ?>"target="_blank"><?php echo $video['title']; ?></a>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
