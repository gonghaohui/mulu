<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\gary\mulu\public/../application/admin\view\zhibo\zhibo_edit.html";i:1671029221;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-fluid layui-col-md12">
    <div class="layui-card">
        ...
        <div class="layui-card-header">修改直播</div>
        <div class="layui-card-body layui-form">
            <div class="layui-row layui-col-space10 layui-form-item ">


                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label"><em>*</em>主队</label>
                    <div class="layui-input-block">
                        <input type="text" class="layui-input " value="<?php echo $data['zhudui']; ?>" name="zhudui" lay-verify="required" placeholder="主队">
                    </div>
                </div>
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label"><em>*</em>客队</label>
                    <div class="layui-input-block">
                        <input type="text" class="layui-input " value="<?php echo $data['kedui']; ?>" name="kedui" lay-verify="required" placeholder="客队">
                    </div>
                </div>

                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label"><em>*</em>直播分类</label>
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input " value="<?php echo $data['bifen']; ?>" name="bifen" placeholder="比分">
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input " value="<?php echo $data['lunci']; ?>" name="lunci" placeholder="轮次">
                    </div>
                </div>
...
<script>
    ...
    layui.use(['form','upload','layedit','element'], function() {
        ...
        form.on('submit(component-form-element)', function (data) {
            ...
            $.ajax({
                url:"<?php echo url('edit_zhibo'); ?>?id=<?php echo $data['id']; ?>",
                type:'post',
                dataType:'json',
                data:data.field,
                success:function(res){
                    if (res.code == 200) {
                        layer.msg(res.msg,{icon:1,time:1500,shade:0.1},function(index){
                            // wk.layer_close();
                            window.location.href="<?php echo url('zhibo_list'); ?>";
                        })
                    } else {
