<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"D:\gary\mulu\public/../application/admin\view\config\index.html";i:1626349985;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-form layui-card-header layuiadmin-card-header-auto">
            ...
            <div>
                <button class="layui-btn" data-type="add" onclick="wk.layer_show('添加配置','<?php echo url('add_config'); ?>')">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="opeBar">
                <a class="layui-btn layui-btn-xs" title="编辑" onclick="wk.layer_show('编辑配置','<?php echo url('edit_config'); ?>?id={{d.id}}')"><i class="fa fa-pencil"></i></a>
                <a class="layui-btn layui-btn-danger layui-btn-xs" title="删除" onclick="wk.confirm('{{d.id}}','<?php echo url('del_config'); ?>')"><i class="fa fa-trash-o"></i></a>
            </script>
            <!--状态模板-->
...
<script>
    layui.use(['index', 'table'], function () {
        ...
        form.on('switch(OnOff)', function (obj) {
            ...
            //配置状态
            wk.status(this.value,num, '<?php echo url("status_config"); ?>',obj);
        });
        //事件
        var active = {
            getCheckData: function(){
                //批量删除
                wk.batchDel(getIds(),"<?php echo url('batchDelConfig'); ?>");
            }
            ,forbiddenAll: function(){
                //批量禁用
                wk.batchForbidden(getIds(),2,"<?php echo url('forbiddenConfig'); ?>");
            }
            ,usingAll: function(){
                //批量启用
                wk.usingAll(getIds(),1,"<?php echo url('usingConfig'); ?>");
            }
        };
