<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\gary\mulu\public/../application/admin\view\tags\data_list.html";i:1630121082;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    layui.use(['index', 'table','util'], function () {
        ...
        table.render({
            ...
            , url: '<?php echo url("tags/data_list"); ?>'
            ,response: {
        ...
        table.on('edit(LAY-table-manage)', function(obj){
            ...
            wk.change(data.tag_id,"<?php echo url('editField'); ?>",field,value,'article_tags');
        });
