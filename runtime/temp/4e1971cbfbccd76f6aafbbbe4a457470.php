<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"D:\gary\mulu\public/../application/admin\view\highlight\highlight_edit_tags.html";i:1671005014;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-fluid layui-col-md12">
    <div class="layui-card">
        ...
        <div class="layui-card-header">修改集锦标签</div>
        <div class="layui-card-body layui-form">
            <div class="layui-row layui-col-space10 layui-form-item ">
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input" disabled="disabled" value="<?php echo $data['title']; ?>" name="title" placeholder="标题">
                    </div>
                </div>
...
<script>
    ...
    function del_tag(r_id,tag_id){
        ...
        $.ajax({
            url:"<?php echo url('del_highlight_tag'); ?>?id=<?php echo $data['id']; ?>",
            type:'post',
            dataType:'json',
            data:{r_id:r_id,tag_id:tag_id},
            success:function(res){
                if (res.code == 200) {
                    window.location.href="<?php echo url('edit_highlight_tags'); ?>?id=<?php echo $data['id']; ?>";
                } else {
                    wk.error(res.msg);
                    return false;
                }
    ...
    $('#add_tags').click(function (){
        ...
        $.ajax({
            url:"<?php echo url('edit_highlight_tags'); ?>?id=<?php echo $data['id']; ?>",
            type:'post',
            dataType:'json',
            data: {tags:tags},
            success:function(res){
