<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\gary\mulu\public/../application/admin\view\news\add_category.html";i:1673435527;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-card-body layui-form">
            <div class="layui-row layui-col-space10 layui-form-item ">
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        ...
                        <select id="type" name="type" lay-verify="required">
                            ...
                            <option value="<?php echo $ta['index']; ?>" <?php if($type== $ta['index']): ?>selected="selected"<?php else: ?>disabled="disabled"<?php endif; ?>><?php echo $ta['key']; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; endif; ?>
                        </select>
                        <?php else: ?>
                        <select id="type" name="type" lay-verify="required">
                            <?php if(!empty($typeArray)): if(is_array($typeArray) || $typeArray instanceof \think\Collection || $typeArray instanceof \think\Paginator): if( count($typeArray)==0 ) : echo "" ;else: foreach($typeArray as $key=>$ta): ?>
                            <option value="<?php echo $ta['index']; ?>" <?php if($type== $ta['index']): ?>selected="selected"<?php endif; ?>><?php echo $ta['key']; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; endif; ?>
                        </select>
                        <?php endif; ?>
                    </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <select id="pid" name="pid" lay-verify="required">
                            ...
                            <option value="<?php echo $vo['category_id']; ?>" <?php if($pid== $vo['category_id']): ?>selected="selected"<?php endif; ?>><?php echo $vo['placeholder']; ?><?php echo $vo['category_name']; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; endif; ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input " id="category_name" name="category_name" lay-verify="required" placeholder="分类名称">
                    </div>
                </div>

                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label"><em>*</em>拼音URL</label>
                    <div class="layui-input-block">
                        <input disabled id="pinyin_other" type="text" style="width: 200px;float: left;" value="<?php echo $pinyin; ?>" class="layui-input " name="pinyin_other" placeholder="url">
                        <input id="pinyin" type="text" style="width: 200px;float: left;margin-left:10px;" class="layui-input " name="pinyin" lay-verify="required" placeholder="拼音">
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="show_navigation" value="1" title="是" >
                        <input type="radio" name="show_navigation" value="0" title="否" checked>
                    </div>
                </div>
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label">推荐</label>
                    <div class="layui-input-block">
                        <input type="radio" name="support" value="1" title="是" >
                        <input type="radio" name="support" value="0" title="否" checked>
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input " id="tag_name" name="tag_name" placeholder="标签名">
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="number" class="layui-input" value="0" onkeyup="value=value.replace(/[^\d]/g,'')" autocomplete="off" name="sort" placeholder="排序(数字越小排越前面)">
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <textarea name="keywords" class="layui-textarea" placeholder="文章描述"></textarea>
                    </div>
                </div>
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label">描述</label>
                    <div class="layui-input-block">
                        <textarea name="description" class="layui-textarea" placeholder="文章描述"></textarea>
                    </div>
                </div>
