<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\gary\mulu\public/../application/tiyu\view\fourth\highlight.html";i:1672917887;s:53:"D:\gary\mulu\application\tiyu\view\public\header.html";i:1671309968;s:53:"D:\gary\mulu\application\tiyu\view\public\footer.html";i:1670883333;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
    ...
    <title><?php echo $fourth['category_name']; ?>集锦</title>
...
<div class="topic_subnav_box">
    <div class="topic_subnav">
        <ul>
            ...
            <ul>
                <li> <a href="" class="hover"><?php echo $fourth['category_name']; ?>集锦首页</a> </li>
...
<div class="content_box">
    ...
    <div class="content_block_left">
        ...
        <div class="news_list two">
            ...
            <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): if( count($lists)==0 ) : echo "" ;else: foreach($lists as $key=>$highlight): ?>
            <div class="block_img">
                <div class="infro">
                    <h1><a href="/<?php echo $f_url; ?>/<?php echo $highlight['id']; ?>.html"><?php echo $highlight['title']; ?></a></h1>
                    <time><?php echo date("Y-m-d",$highlight['create_time']); ?></time>
                </div>
            </div>
            <?php endforeach; endif; else: echo "" ;endif; ?>
