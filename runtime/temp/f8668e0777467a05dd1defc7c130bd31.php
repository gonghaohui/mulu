<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\gary\mulu\public/../application/tiyu\view\second\new_football.html";i:1672999401;s:53:"D:\gary\mulu\application\tiyu\view\public\header.html";i:1671309968;s:53:"D:\gary\mulu\application\tiyu\view\public\footer.html";i:1670883333;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
        ...
        <div class="toc_left_w665">
            <div class="topic_match_box">
                <div class="topic_tag_title">
                    ...
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    <i>|</i> <a href="/<?php echo $all_games_url['pinyin']; ?>/index.html">全部直播 <s>&gt;</s></a>
                </div>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="/<?php echo $top_category[$top['top_id']]; ?>/<?php echo $top['article_id']; ?>.html" target="_blank"> <img src="<?php echo $top['thumbnail']; ?>" alt="<?php echo $top['title']; ?>"/>
                                ...
                                <?php switch($k): case "1": ?><strong>足球最Top</strong><?php break; case "2": ?><strong>足球万花筒</strong><?php break; default: ?><strong>足球麻辣烫</strong>
                                <?php endswitch; ?>
                            </a>
                        </li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
