<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"D:\gary\mulu\public/../application/tiyu\view\content\new.html";i:1672996293;s:53:"D:\gary\mulu\application\tiyu\view\public\header.html";i:1671309968;s:53:"D:\gary\mulu\application\tiyu\view\public\footer.html";i:1670883333;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
    ...
    <meta content="<?php echo $new['description']; ?>" name="description">
    <meta content="<?php echo $new['keywords']; ?>" name="keywords">
...
<div class="topic_subnav_box">
    <div class="topic_subnav">
        <ul>
            <?php if($new['pinyin'] != null): ?>
            <li> <a href="/<?php echo $new['pinyin']; ?>/index.html" class="hover"><?php echo $new['name']; ?>新闻</a> </li>
            <?php endif; if($zhibo_category['pinyin'] != null): ?>
            <li> <a href="/<?php echo $zhibo_category['pinyin']; ?>/index.html" class=""><?php echo $new['name']; ?>直播</a> </li>
            <?php endif; if($video_category['pinyin'] != null): ?>
            <li> <a href="/<?php echo $video_category['pinyin']; ?>/index.html" class=""><?php echo $new['name']; ?>录像</a> </li>
            <?php endif; if($highlight_category['pinyin'] != null): ?>
            <li> <a href="/<?php echo $highlight_category['pinyin']; ?>/index.html" class=""><?php echo $new['name']; ?>集锦</a> </li>
            <?php endif; ?>
        </ul>
    </div>
</div>
...
<div class="content_box">
    <div class="local"><span class="one">当前位置：</span>
        ...
        <a href="/<?php echo $new['pinyin']; ?>/index.html"><span><?php echo $new['category_name']; ?></span></a>
    </div>
        ...
        <div class="articles_text_box">
            ...
            <div class="articles_text">
                <div class="title">
                    ...
                    <time><?php echo date("Y-m-d H:i:s",$new['create_time']); ?></time>
                </div>
                <p>
    ...
    <div class="content_right">
        <?php if(is_array($tag_list) || $tag_list instanceof \think\Collection || $tag_list instanceof \think\Paginator): $i = 0; $__LIST__ = $tag_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tag_new): $mod = ($i % 2 );++$i;?>
        <div class="block">
            <div class="block_title">
                <h1>相关<?php echo $tag_new['tag_name']; ?>新闻</h1>
            </div>
            <div class="hot_video_con">
                <ul>
                    <?php if(is_array($tag_new['news']) || $tag_new['news'] instanceof \think\Collection || $tag_new['news'] instanceof \think\Paginator): $i = 0; $__LIST__ = $tag_new['news'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?>
