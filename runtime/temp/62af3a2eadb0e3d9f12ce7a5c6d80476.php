<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\gary\mulu\public/../application/admin\view\articles\data_list.html";i:1636134988;s:54:"D:\gary\mulu\application\admin\view\public\header.html";i:1628315520;s:54:"D:\gary\mulu\application\admin\view\public\footer.html";i:1628864820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-card">
                ...
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <select name="category" id="category" class="layui-input">
                            ...
                            <option value="<?php echo $vo['category_id']; ?>"><?php echo $vo['placeholder']; ?><?php echo $vo['category_name_cn']; ?></option>
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="staBar">
                <input type="checkbox" value="{{d.article_id}}"  lay-skin="switch"  lay-text="ON|OFF" lay-filter="OnOff"{{ d.status == 1 ? 'checked' : '' }}  >
            </script>
            <!--操作模板-->
            <script type="text/html" id="opeBar">
                <a class="layui-btn layui-btn-xs" title="编辑" onclick="wk.href('<?php echo url('edit_article'); ?>?id={{d.article_id}}')"><i class="fa fa-pencil"></i></a>
                <a class="layui-btn layui-btn-info layui-btn-xs" title="编辑标签" onclick="wk.href('<?php echo url('edit_article_tags'); ?>?id={{d.article_id}}')"><i class="fa fa-tag"></i></a>
...
<script>
    layui.use(['index', 'table'], function () {
        ...
        table.render({
            ...
            , url: '<?php echo url("articles/data_list"); ?>'
            ,response: {
        ...
        var active = {
            getCheckData: function(){
                //批量删除
                wk.batchDel(getIds(),"<?php echo url('batchDelArticles'); ?>");
            }
        };
    ...
    function del_article(obj,id){
        layer.confirm('确认删除吗?', {icon: 7, title:'警告'}, function(index){
            //do something
            $.getJSON('<?php echo url("del_article_data"); ?>', {'id' : id}, function(res){
                if(res.code == 200){
